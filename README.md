# Rotisera-Todo-Casero
<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <meta name="description" content="Todo Casero - Rotisería en Campana con los mejores sándwiches, pizzas y pastas caseras. Abierto de Lun-Dom: 20:00-23:45">
...
<section class="section" id="pedidos">
  ...
  <div class="info-cards">
    ...
    <div class="info-card">
      ...
      <p>Retira tu pedido en nuestro local en Campana en el horario acordado.</p>
    </div>
  </div>
</section>
  ...
  <div class="footer-content">
    ...
    <div class="footer-section">
      ...
      <ul>
        ...
        <li><i class="fas fa-clock"></i> Lun-Dom: 20:00-23:45</li>
      </ul>
    </div>
  </div>
...
<script>
  const defaultProducts = [
    { id: 1, category: "Sándwiches", name: "Bondiola", price: 9000, description: "Delicioso sándwich de bondiola casera c/Fritas." },
    { id: 2, category: "Sándwiches", name: "Bondiola Especial", price: 10000, description: "Bondiola con extras especiales c/Fritas." },
    { id: 3, category: "Sándwiches", name: "Bondiola Premium", price: 11000, description: "Bondiola premium con ingredientes selectos c/Fritas." },
    { id: 4, category: "Sándwiches", name: "Milanesa", price: 9500, description: "Clásico sándwich de milanesa con lechuga y tomate c/Fritas." },
    { id: 5, category: "Sándwiches", name: "Milanesa Especial", price: 10500, description: "Milanesa con extras especiales c/Fritas." },
    { id: 6, category: "Sándwiches", name: "Milanesa Completa", price: 11500, description: "Milanesa completa con todos los complementos c/Fritas." },
    { id: 7, category: "Sándwiches", name: "Tucumano", price: 14000, description: "Sándwich tucumano tradicional c/Fritas Doble." },
    { id: 8, category: "Sándwiches", name: "Lomito Simple", price: 10000, description: "Lomito jugoso con tomate y lechuga c/Fritas." },
    { id: 9, category: "Sándwiches", name: "Lomito Especial", price: 10500, description: "Lomito con extras especiales c/Fritas." },
    { id: 10, category: "Sándwiches", name: "Lomito Premium", price: 11000, description: "Lomito premium con ingredientes selectos c/Fritas." },
    { id: 11, category: "Hamburguesas", name: "Hamburguesa Completa", price: 8500, description: "Con lechuga, tomate, queso y mayonesa c/Fritas." },
    { id: 12, category: "Hamburguesas", name: "Hamburguesa Vegetariana", price: 8500, description: "Hamburguesa vegetariana deliciosa c/Fritas." },
    { id: 13, category: "Hamburguesas", name: "Hamburguesa Doble", price: 10500, description: "Doble carne y queso c/Fritas." },
    { id: 14, category: "Hamburguesas", name: "Hamburguesa Zapping", price: 25000, description: "Hamburguesa especial Zapping c/Fritas Doble." },
    { id: 15, category: "Pizzas", name: "Muzzarella", price: 10000, description: "Pizza clásica con queso muzzarella,oregano, aceitunas." },
    { id: 16, category: "Pizzas", name: "Fugaza", price: 11000, description: "Pizza fugaza tradicional." },
    { id: 17, category: "Pizzas", name: "Napolitana", price: 11500, description: "Pizza napolitana con tomate, ajo y oregano." },
    { id: 18, category: "Pizzas", name: "Especial", price: 12000, description: "Pizza especial con jamon, morrones y aceitunas." },
    { id: 19, category: "Pizzas Individuales", name: "Muzzarella Individual", price: 5500, description: "Individual con queso muzzarella." },
    { id: 20, category: "Pizzas Individuales", name: "Fugaza Individual", price: 6000, description: "Individual fugaza tradicional." },
    { id: 21, category: "Pizzas Individuales", name: "Napolitana Individual", price: 6500, description: "Individual napolitana con tomate y ajo." },
    { id: 22, category: "Pizzas Individuales", name: "Especial Individual", price: 7000, description: "Individual especial con jamon y morrones." },
    { id: 23, category: "Pastas", name: "Tallarines con Bolognesa", price: 8500, description: "Pasta fresca con salsa bolognesa casera." },
    { id: 24, category: "Pastas", name: "Ñoquis con Bolognesa", price: 8500, description: "Ñoquis frescos con salsa bolognesa." },
    { id: 25, category: "Pastas", name: "Ravioles con Bolognesa", price: 9500, description: "Ravioles frescos con salsa bolognesa." },
    { id: 26, category: "Acompañamientos", name: "Porción de Fritas", price: 4500, description: "Porción grande de papas fritas." },
    { id: 27, category: "Acompañamientos", name: "Cono de Fritas", price: 3500, description: "Cono mediano de papas fritas." },
    { id: 28, category: "Empanadas", name: "Empanadas", price: 17000, description: "Empanadas de Carne caseras x 12 unidades." },
    { id: 29, category: "Empanadas", name: "Empanadas", price: 8500, description: "Empanadas de Carne caseras x 6 unidades." },
    { id: 30, category: "Postres", name: "Flan", price: 3500, description: "Con crema o mixto(Dulce de Leche y Crema)." },
    { id: 31, category: "Postres", name: "Torta Helada", price: 4500, description: "Crema Americana con Dulce de Leche." },
    { id: 32, category: "Postres", name: "Panqueque", price: 4500, description: "Dulce de Leche, Chocolate y canela." }
  ];


  const defaultOffers = [
    { id: 1, day: "Lunes", description: "Pastas 10% los Lunes", discount: 10 },
    { id: 2, day: "Miércoles", description: "Sándwich de Bondiola 10% los Miércoles", discount: 10 }
  ];
  ...
  function generatePDF() {
    ...
    doc.setFontSize(18);
    doc.text("Factura Todo Casero", 20, 20);
    doc.setFontSize(12);
    doc.text(`Fecha: ${new Date().toLocaleString('es-AR')}`, 20, 30);
    doc.text("Dirección: Campana, Buenos Aires", 20, 40);
    doc.text("Teléfono: +543489358998", 20, 50);
  ...
  function sendChatMessage() {
    ...
    const closing = "¿Querés agregar algo mas? 😊";
    ...
    if (lowerMessage.includes("resumen pdf") || lowerMessage.includes("generar pdf")) {
      if (cart.length > 0) {
        generatePDF();
        response += "¡Listo! He generado el resumen de tu pedido en PDF. 📄 ¿Querés confirmar el pedido por WhatsApp o añadir algo más?";
      } else {
        response += "Tu carrito está vacío. 😔 Por favor, añadí algunos productos antes de generar un resumen.";
      }
    } else if (lowerMessage.includes("cancelar pedido")) {
      if (cart.length > 0) {
        cart = [];
        updateCartDisplay();
        response += "¡Pedido cancelado! 😊 ¿Querés empezar un nuevo pedido?";
      } else {
        response += "No hay ningún pedido para cancelar. 😔 ¿Querés armar uno nuevo?";
      }
    } else {
      ...
      if (orderMatches.length > 0) {
        ...
        if (orderDetails.length > 0) {
          ...
          response += `\n💰 *Total*: $${total.toLocaleString('es-AR')}\n`;
          response += `${paymentInfo} ¿Querés confirmar este pedido por WhatsApp o añadir algo más?`;
         
          if (unmatchedItems.length > 0) {
            response += `\n⚠️ No pude identificar: ${unmatchedItems.join(', ')}. Por favor, verificá los nombres en el menú (ej: 'Sándwich de Bondiola', 'Muzzarella').`;
          }
          ...
          response += "No pude identificar los productos en tu pedido. 😔 Por favor, asegurate de escribir los nombres como aparecen en el menú de Todo Casero (ej: 'Sándwich de Bondiola', 'Muzzarella'). ¿Podés intentarlo de nuevo?";
        }
      } else if (lowerMessage.includes("hola") || lowerMessage.includes("buenas")) {
        response += "Bienvenido/a a Todo Casero, una rotisería con corazón artesanal. 🍔 ¿En qué puedo ayudarte hoy?";
      } else if (lowerMessage.includes("horario") || lowerMessage.includes("hora")) {
        response += "Estamos abiertos de Lunes a Domingo de 20:00 a 23:45. 🕗 ¿Querés hacer un pedido ahora?";
      } else if (lowerMessage.includes("ubicación") || lowerMessage.includes("Campana")) {
        response += "Nos encontramos en Campana, Buenos Aires. 📍 ¿Te ayudo a planificar tu pedido?";
      } else if (lowerMessage.includes("menú") || lowerMessage.includes("menu") || lowerMessage.includes("carta")) {
        response += "Nuestro menú incluye sándwiches, pizzas, pastas, hamburguesas, lomitos, bondiola y acompañamientos como papas fritas. 😋 Podés verlo en la sección 'Menú' o preguntarme por algo específico.";
      } else if (lowerMessage.includes("precio") || lowerMessage.includes("cuanto cuesta")) {
        const productName = lowerMessage.replace(/precio de|cuanto cuesta|el precio de/gi, "").trim();
        const product = products.find(p => p.name.toLowerCase().includes(productName));
        if (product) {
          response += `El ${product.name} cuesta $${product.price.toLocaleString('es-AR')}. ${product.description} ¿Querés añadirlo al carrito?`;
        } else {
          response += "No encontré ese producto. 😔 ¿Podrías especificar más o revisar nuestro menú en la sección 'Menú'?";
        }
      } else if (lowerMessage.includes("sándwich") || lowerMessage.includes("sandwich")) {
        const sandwiches = products.filter(p => p.category === "Sándwiches");
        response += "Tenemos deliciosos sándwiches como el de Bondiola ($9.000), Milanesa ($9.500) o Lomito ($10.000). ¿Cuál te tienta?";
      } else if (lowerMessage.includes("pizza")) {
        const pizzas = products.filter(p => p.category === "Pizzas" || p.category === "Pizzas Individuales");
        response += "Ofrecemos pizzas clásicas como la Muzzarella ($10.000) o individuales como la Muzzarella Individual ($5.500). 🍕 ¿Cuál preferís?";
      } else if (lowerMessage.includes("pasta")) {
        const pastas = products.filter(p => p.category === "Pastas");
        response += "Nuestras pastas caseras incluyen Tallarines con Bolognesa ($8.500). 🍝 ¿Te apetece?";
      } else if (lowerMessage.includes("hamburguesa")) {
        const burgers = products.filter(p => p.category === "Hamburguesas");
        response += "Tenemos hamburguesas como la Completa ($8.500). 🍔 ¿Querés probarla?";
        ...
        response += "Ofrecemos acompañamientos como Porción de Fritas ($4.500) o Cono de Fritas ($3.500). 🍟 ¿Querés añadir alguno?";
      } else if (lowerMessage.includes("oferta") || lowerMessage.includes("promoción")) {
        const today = new Date().toLocaleString('es-AR', { weekday: 'long' });
        const todayOffer = offers.find(offer => offer.day === today);
        if (todayOffer) {
          response += `¡Hoy ${today} tenemos una oferta especial! ${todayOffer.description}. ¿Querés aprovecharla?`;
        } else {
          response += "No tenemos ofertas para hoy, pero podés consultar nuestras promociones semanales en el menú. 😊 ¿Algo más en lo que pueda ayudarte?";
        }
      } else if (lowerMessage.includes("pago") || lowerMessage.includes("método de pago")) {
        response += `${paymentInfo} ¿Cómo preferís pagar?`;
      } else if (lowerMessage.includes("pedido") || lowerMessage.includes("cómo pedir")) {
        response += "Podés elegir tu comida desde el menú, añadirla al carrito y enviar el pedido por WhatsApp desde nuestra web. También podés decirme qué querés pedir y te ayudo a calcularlo. 😊 ¿Querés empezar un pedido?";
      } else {
        response += "Entiendo, pero no estoy segura de lo que necesitas. 😔 ¿Podés darme más detalles o preguntarme por el menú, horarios o algo específico?";
      }
    }
    ...
    products.forEach(product => {
      ...
      div.innerHTML = `
        ...
        <div>
          ...
          <button class="btn" style="background-color: #e74c3c;" onclick="deleteProduct(${product.id})">Borrar</button>
        </div>
      `;
  ...
  document.getElementById("sendOrder").addEventListener("click", () => {
    if (cart.length === 0) {
      alert("El carrito está vacío. Añadí productos antes de enviar el pedido.");
      return;
    }
    generatePDF();
  ...
  document.getElementById("productForm").addEventListener("submit", function(e) {
    ...
    if (editingProductId) {
      products = products.map(p => p.id === editingProductId ? { ...p, category, name, price, description, image } : p);
    } else {
      const id = products.length ? Math.max(...products.map(p => p.id)) + 1 : 1;
      products.push({ id, category, name, price, description, image });
    }
